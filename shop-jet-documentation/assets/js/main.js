(function ($) {
  ...
  $(document).ready(function () {
    ...
    function sidebarActiveTabs(type = "") {
      ...
      if (currentSubLink != "") {
        var currentSubActiveEle = $(
          `a.gx-page-link:contains('${currentSubLink}')`
        ).filter(function () {
    ...
    $(".gx-drop-toggle").on("click", function (e) {
      ...
      if (
        ...
        $(senderElement).parents(".gx-sub-drop-toggle").length > 0
      )
        return;
    ...
    $(".gx-sub-drop-toggle").on("click", function (e) {
      ...
      currentActiveSubTab = $(parent)
        .find(".gx-sub-drop-toggle span.condense")
        .text();
    ...
    function setgxPagelink(_this) {
      ...
      if (mainParentHas) {
        currentActiveTab = $(mainParentHas)
          .find(".gx-drop-toggle span.condense")
          .text();
  ...
  $(".gx-full-card").on("click", function () {
    ...
    $(this)
      ...
      .parent()
      .parent()
      .append('<div class="gx-card-overlay"></div>');
  });
